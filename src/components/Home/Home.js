        ...
        <div>
            <div className="product-container">
                <div className="product-info">
                    ...
                    <button className='bg-blue-200 text-blue-900 font-bold py-4 px-16 text-xl rounded-lg mt-12 absolute left-28'>Live Demo</button>
                </div>
            ...
            <div className="review">
                ...
                <div className='grid grid-cols-3 my-10 p-4'>
                   {
